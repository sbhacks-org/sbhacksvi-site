		...
		if (process.env["decisions_released"] === "true")
		{
			return application.accepted ?
				(<div className="body">
					...
					<p className="body-text">We received an overwhelming 2,100+ applications this year for our limited 500 spots. To confirm your registration and save your spot, take a minute to <strong>RSVP</strong> no later than <strong>Friday, January 4th, 11:59 PM</strong>.</p>
				</div>) : 
				(<div className="body">
					<p className="body-text">Unfortunately, we are unable to offer you admission to SB Hacks V. We had an overwhelming 2,100+ applications this year for our limited 500 spots. We encourage you to apply next year. Best of luck!</p>
				</div>)
		}
		else
		{
