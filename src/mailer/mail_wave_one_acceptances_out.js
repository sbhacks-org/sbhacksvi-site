...
let renderText = renderTemplate("wave_one_email.txt.ejs");
let renderHTML = renderTemplate("wave_one_email.ejs");
...
.then((content) => {
	...
	let email_data = fs.readFileSync("./sbh6_wave_one_accepted.json", "utf-8");
